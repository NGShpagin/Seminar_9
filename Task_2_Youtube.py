...
class App():
    def __init__(self):
        ...
        self.logo_video.setStyleSheet(
            "background: #363b41; border-top-left-radius: 10px; border-bottom-left-radius: 10px;")

        self.video_input = QtWidgets.QLineEdit(self.frame)
        self.video_input.setGeometry(90, 50, 300, 50)
        self.video_input.setStyleSheet(
            "border-bottom-right-radius: 10px; border-top-right-radius: 10px; font-family: Trebuchet MS; font-size:18px; color:white; background: rgba(0,0,0,0.1);")
        ...
        self.button_black.setStyleSheet(
            "QPushButton{background:#f774a7; border-top-left-radius: 10px; border-bottom-left-radius: 10px;}\n" "QPushButton:hover{background: #e6397b;}")
        ...
        self.button_white.setStyleSheet(
            "QPushButton{background:#f774a7; border-top-right-radius: 10px; border-bottom-right-radius: 10px;}\n" "QPushButton:hover{background: #e6397b;}")
    ...
    def sun_theme(self):
        ...
        self.logo_video.setStyleSheet(
            "background: #add8ff; border-top-left-radius: 10px; border-bottom-left-radius: 10px;")
        ...
        self.button_black.setStyleSheet(
            "QPushButton{background:#42a4ff; border-top-left-radius: 10px; border-bottom-left-radius: 10px;}\n" "QPushButton:hover{background: #2696ff;}")
        self.button_white.setStyleSheet(
            "QPushButton{background:#42a4ff; border-top-right-radius: 10px; border-bottom-right-radius: 10px;}\n" "QPushButton:hover{background: #2696ff;}")
